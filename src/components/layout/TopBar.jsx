        ...
        <header className="flex items-center justify-between border-b border-gray-100 px-2 md:px-6 py-4 bg-[#FCFCFC] shadow-lg">
            ...
            <div className=' my-3 md:block hidden  mx-20'>
                <a
                    ...
                    className='!bg-transparent border-2 border-[#680D3A] w-full md:w-auto h-[30px] !rounded-full !font-black  text-[#680D3A] inline-flex items-center justify-center px-6 py-4 text-sm  transition-colors
